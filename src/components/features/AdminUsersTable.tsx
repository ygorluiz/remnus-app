...
type SortKey = 'name' | 'email' | 'role' | 'authType' | 'createdAt' | 'lastActive' | 'totalSeconds' | 'storageBytes' | 'mcpCalls' | 'tier';
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="border-b border-neutral-800 bg-neutral-900/60">
                ...
                <Th sk="role" label={t('colRole')} sortKey={sortKey} sortDir={sortDir} onSort={toggleSort} className="hidden md:table-cell w-28" />
                  ...
                  >
                    ...
                    <td className="hidden md:table-cell px-4 py-3">
                      {u.role === 'admin' || u.role === 'super_admin' ? (
                        ...
                        <span className="text-xs text-neutral-500">{t('roleMember')}</span>
                      )}
                    </td>
                    <td className="hidden md:table-cell px-4 py-3">
                      {u.tier === 'free' ? (
